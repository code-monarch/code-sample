...
// Break this component down into smaller components
              ...
              <AlertDialogueTrigger>
                <CardCTA
                  ...
                  onClick={() => {
                    ...
                    dispatch(setBillingAmount(`${annualPricing[0].tierOne}`));
                  }}
                >
                  Subscribe Now
                </CardCTA>
        ...
        <CardHeader classstyle='!p-[24px] !pb-0'>
          <FullWidth classstyle='flex flex-col items-start pb-[24px] space-y-[16px] border-b-[1px]'>
            ...
            >
              ...
              &nbsp;
              {/* Previous Price */}
              <p className='inline line-through text-[16px]'>74,280</p>
            </Heading>
          </FullWidth>
        </CardHeader>
        {/* Card Header End */}
              ...
              <AlertDialogueTrigger>
                <CardCTA
                  ...
                  onClick={() => {
                    ...
                    dispatch(setBillingAmount(`${annualPricing[0].tierTwo}`));
                  }}
                >
                  Subscribe Now
                </CardCTA>
        ...
        <CardHeader classstyle='!p-[24px] !pb-0'>
          <FullWidth classstyle='flex flex-col items-start pb-[24px] space-y-[16px] border-b-[1px]'>
            ...
            >
              ...
              &nbsp;
              {/* Previous Price */}
              <p className='inline line-through text-[16px]'>144,662</p>
            </Heading>
          </FullWidth>
        </CardHeader>
        {/* Card Header End */}
