...
const BiAnnualPricing = () => {
  ...
  return (
    <div className={pricingTabStyle.tierWrapper}>
              ...
              <AlertDialogueTrigger>
                <CardCTA
                  ...
                  onClick={() => {
                    ...
                    dispatch(setBillingAmount(`${biAnnualPricing[0].tierOne}`));
                  }}
                >
                  Subscribe Now
                </CardCTA>
        ...
        <CardHeader classstyle='!p-[24px] !pb-0'>
          <FullWidth classstyle='flex flex-col items-start pb-[24px] space-y-[16px] border-b-[1px]'>
            ...
            >
              ...
              &nbsp;
              {/* Previous Price */}
              <p className='inline line-through text-[16px]'>16,563</p>
            </Heading>
          </FullWidth>
        </CardHeader>
        {/* Card Header End */}
              ...
              <AlertDialogueTrigger>
                <CardCTA
                  ...
                  onClick={() => {
                    ...
                    dispatch(setBillingAmount(`${biAnnualPricing[0].tierTwo}`));
                  }}
                >
                  Subscribe Now
                </CardCTA>
        ...
        <CardHeader classstyle='!p-[24px] !pb-0'>
          <FullWidth classstyle='flex flex-col items-start pb-[24px] space-y-[16px] border-b-[1px]'>
            ...
            >
              ...
              <p className='inline font-[600] text-[24px] text-black'>
                {" "}
                {biAnnualPricing.map(({ tierThree }, i) => (
                  <span key={i} className='inline'>
                    {" "}
                    {tierThree}
                  </span>
              ...
              &nbsp;
              {/* Previous Price */}
              <p className='inline line-through text-[16px]'>33,126</p>
            </Heading>
          </FullWidth>
        </CardHeader>
        {/* Card Header End */}
      ...
      {/* Teir Three Pricing Card End */}
    </div>
  );
};

export default BiAnnualPricing;
